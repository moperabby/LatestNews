...
function newsstar_css_and_js() {
   ...
   wp_register_style('owl_carousel_min',get_template_directory_uri() .'/css/owl.carousel.min.css');
   wp_register_style('archive-style',get_template_directory_uri() .'/css/archive-style.css');
   ...
   wp_register_style('style',get_stylesheet_uri() );
	...
	wp_register_script('owl_carousel_min', get_template_directory_uri() .'/js/owl.carousel.min.js', array());
